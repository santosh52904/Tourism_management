...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        String[] text=new String[]{"JW Marriott Hotel","Madarian Hotel","Four Seasons Hotel","Readison blue Hotel","Classic Hotel","The BayClab Hotel","Breeze Bow Hotel","The Thaj hotel","Happy Morning Hotel","River View Hotel"};
