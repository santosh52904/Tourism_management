...
//image name s are not correct  

public class Destinations extends JFrame implements Runnable{
    Thread t1;
    JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10;
    //no need o initialise
    JLabel[] label=new JLabel[]{l1,l2,l3,l4,l5,l6,l7,l8,l9,l10};
//    JLabel caption;
    
    public void run(){
       // String[] text=new String[]{"Madarian Hotel","Four Seasons Hotel","Readison blue Hotel","Classic Hotel","The BayClab Hotel","Breeze Bow Hotel","The Thaj hotel","Happy Morning Hotel","River View Hotel"};
