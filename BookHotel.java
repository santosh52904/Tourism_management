...
public class BookHotel extends JFrame implements ActionListener {
    ...
    BookHotel(String username){
       ...
       try{
        ...
        labelprice.setBounds(250, 440, 150, 25);
        add(labelprice);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==checkprice){
            ...
            try{
                Conn c=new Conn();
   String q1="insert into bookhotel values('"+labelusername.getText()+"','"+chotel.getSelectedItem()+"','"+tfpersons.getText()+"','"+tfdays.getText()+"','"+cac.getSelectedItem()+"','"+cfood.getSelectedItem()+"','"+labelid.getText()+"','"+labelnumber.getText()+"','"+labelphone.getText()+"','"+labelprice.getText()+"')";                
